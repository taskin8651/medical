...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
    <div>
        <a href="{{ route('admin.brands.index') }}" style="font-size:13px; color:var(--accent); text-decoration:none; font-weight:600; display:inline-flex; align-items:center; gap:5px; margin-bottom:6px;">&larr; Back to brands</a>
        <h2 style="font-size:22px; font-weight:700; color:#0F172A; margin:0;">Add Brand</h2>
        <p style="font-size:13px; color:#64748B; margin:4px 0 0;">Create a new brand for products.</p>
    </div>
</div>
...
<form method="POST" action="{{ route('admin.brands.store') }}">
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <div class="field-group">
                ...
                <input type="text" name="manufacturer_name" id="manufacturer_name" value="{{ old('manufacturer_name') }}" class="field-input">
            </div>
            <div class="field-group">
                <label class="field-label" for="drug_license_no">Drug License No</label>
                <input type="text" name="drug_license_no" id="drug_license_no" value="{{ old('drug_license_no') }}" class="field-input">
            </div>
            <div class="field-group">
                <label class="field-label" for="gst_no">GST No</label>
                <input type="text" name="gst_no" id="gst_no" value="{{ old('gst_no') }}" class="field-input">
            </div>
            <div class="field-group">
    ...
    <div style="display:flex; justify-content:flex-end; gap:12px; margin-top:18px;">
        ...
        <button type="submit" class="btn-primary"><i class="fas fa-save"></i> Save Brand</button>
    </div>
</form>
