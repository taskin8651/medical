...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
    <div>
        ...
        <h2 style="font-size:22px; font-weight:700; color:#0F172A; margin:0;">Add Category</h2>
        <p style="font-size:13px; color:#64748B; margin:4px 0 0;">Create a new category for products.</p>
    </div>
</div>
    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <div>
                ...
                <p style="font-size:12px; color:#94A3B8; margin:0;">Basic category details</p>
            </div>
        </div>
