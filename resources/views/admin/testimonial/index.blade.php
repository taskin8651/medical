...
<div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px; margin-bottom:24px;">
    <div>
        <h2 style="font-size:22px; font-weight:700; color:#0F172A; margin:0;">Testimonials</h2>
...
<div class="table-card">
    <div class="table-card-header">
        <p style="font-size:14px; font-weight:700; color:#0F172A; margin:0;">All Testimonials</p>
    </div>
    <div class="table-card-body">
        <table class="table-list">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="5" style="padding:18px 18px; color:#64748B;">No testimonials found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
