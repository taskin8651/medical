...
<div style="display:flex; align-items:center; justify-content:space-between; gap:12px; margin-bottom:24px; flex-wrap:wrap;">
    <div>
        ...
        <h2 style="font-size:22px; font-weight:700; margin:8px 0 0; color:#0F172A;">Add Testimonial</h2>
        <p style="font-size:13px; color:#64748B; margin:4px 0 0;">Create a new customer testimonial.</p>
    </div>
</div>
...
<form method="POST" action="{{ route('admin.testimonial.store') }}" enctype="multipart/form-data">
    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <div>
                ...
                <p style="font-size:12px; color:#94A3B8; margin:0;">Add name, title and message.</p>
            </div>
        </div>
        <div class="form-card-body">
            ...
            <div class="field-group">
                ...
                <input type="text" name="designation" id="designation" value="{{ old('designation') }}" class="field-input">
            </div>
            <div class="field-group">
    ...
    <div style="display:flex; justify-content:flex-end; gap:12px; margin-top:18px;">
        ...
        <button type="submit" class="btn-primary"><i class="fas fa-save"></i> Save Testimonial</button>
    </div>
</form>
@endsection