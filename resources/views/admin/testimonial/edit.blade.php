...
<form method="POST" action="{{ route('admin.testimonial.update', $testimonial) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            <div class="field-group">
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $testimonial->name) }}" class="field-input">
            ...
            <div class="field-group">
                ...
                <input type="text" name="designation" id="designation" value="{{ old('designation', $testimonial->designation) }}" class="field-input">
            </div>
            <div class="field-group">
                <label class="field-label" for="message">Message <span style="color:#EF4444;">*</span></label>
                <textarea name="message" id="message" class="field-textarea">{{ old('message', $testimonial->message) }}</textarea>
            ...
            <div class="field-group">
                ...
                <p style="font-size:12px; color:#475569; margin-top:8px;">Current: <img src="{{ $testimonial->getFirstMediaUrl('testimonial') }}" alt="Testimonial" style="max-height:60px; margin-top:6px; display:block; border-radius:10px;"></p>
                @endif
            </div>
            <div class="field-group">
