...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
    <div>
        <div style="display:flex; align-items:center; gap:8px; margin-bottom:4px;">
            <a href="{{ route('admin.roles.index') }}" style="font-size:13px; color:var(--accent); text-decoration:none; font-weight:600; display:inline-flex; align-items:center; gap:5px; margin-bottom:6px;">
        ...
        <p style="font-size:13px; color:#64748B; margin:4px 0 0;">Create a new role and assign permissions</p>
    </div>
</div>
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; max-height:280px; overflow-y:auto; padding-right:4px;">
                ...
                <label class="role-checkbox-item {{ in_array($id, old('permissions', [])) ? 'checked' : '' }}" data-id="{{ $id }}">
