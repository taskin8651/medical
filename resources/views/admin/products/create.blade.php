        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p style="font-size:12px; color:#94A3B8; margin:0;">Basic product information</p>
                </div>
            </div>
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <textarea name="short_description" id="short_description" class="field-textarea {{ $errors->has('short_description') ? 'error' : '' }}">{{ old('short_description') }}</textarea>
                    @error('short_description')<p class="field-error"><i class="fas fa-exclamation-circle"></i> {{ $message }}</p>@enderror
                </div>
                <div class="field-group">
                    <label class="field-label" for="description">Description</label>
                    <textarea name="description" id="description" class="field-textarea {{ $errors->has('description') ? 'error' : '' }}">{{ old('description') }}</textarea>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p style="font-size:12px; color:#94A3B8; margin:0;">Rules, pricing and availability</p>
                </div>
            </div>
            <div class="form-card-body">
                <div class="grid-cols-2">
                ...
                <div class="grid-cols-2">
                    ...
                    <div class="field-group">
                        ...
                        <input type="number" name="stock" id="stock" value="{{ old('stock', 0) }}" class="field-input {{ $errors->has('stock') ? 'error' : '' }}">
